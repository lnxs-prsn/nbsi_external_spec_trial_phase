...
class ConceptGraph:
    ...
    def add_edge(self, edge: ConceptEdge) -> None:
        ...
        Silently drops edges whose endpoints are not in _nodes —
        this handles merged/pruned nodes without crashing.
        """
        # Both endpoints must exist in _nodes for hop_score to work
    ...
    def prune_by_betweenness(self, max_nodes: int) -> list[str]:
        ...
        candidates = [
            ...
            if nid in self._nodes and not self._nodes[nid].protected
        ]
